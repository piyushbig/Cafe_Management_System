...
function RegistraterCafe() {
  ...
  const handleSubmit = (event) => {
    ...
    return (
        ...
        <div>
          <h1 className="text-center mb-5">Register Your Cafe Here!!!</h1>
        </div>
    <Form noValidate validated={validated} onSubmit={handleSubmit}>
      <Row className="mb-3">
        <Form.Group as={Col} md="6" controlId="validationCustom01">
          <Form.Label className='label'>Cafe name</Form.Label>
          <Form.Control
            required
            type="text"
...
export default RegistraterCafe;