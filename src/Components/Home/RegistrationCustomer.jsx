...
function RegisterCustomer() {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'contact' || name === 'streets' || name === 'city' || name === 'pincode') {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post('http://localhost:8089/customer/register', customer);
    ...
    <Form noValidate validated={validated} onSubmit={handleSubmit}>
      ...
      <Row className="mb-3">
        <Form.Group as={Col} md="6" className='mt-3' controlId="validationCustom03">
          ...
          <Form.Control type="text" placeholder="contact"  name='contact' onChange={handleChange} required />
          <Form.Control.Feedback type="invalid">
        ...
        <Form.Group as={Col} md="6" className='mt-3' controlId="validationCustom04">
          ...
          <Form.Control type="text" as="textarea" name='street' rows={3} placeholder="Street" onChange={handleChange} required />
          <Form.Control.Feedback type="invalid">
        ...
        <Form.Group as={Col} className='mt-3' md="6" controlId="validationCustom05">
          ...
          <Form.Control type="text" placeholder="pincode" name='pincode' onChange={handleChange} required />
          <Form.Control.Feedback type="invalid">
